                  ...
                  <Row>
                    <Col md="12">
                      <Form.Group>
                        <label>Address</label>
                        <Form.Control
                          defaultValue="1234 Some Address"
            ...
            <Card className="card-user">
              ...
              <Card.Body>
                <div className="author">
                  ...
                  <p className="description">Mary123</p>
                </div>
                <p className="description text-center">
                  Watercolor Artist and Micro-Entrepreneur<br></br>
                </p>
              </Card.Body>
              <hr></hr>
